export default {
  ...
  settings: {
    ...
    reset: '재설정',
    profile: '프로필',
    profileDesc: '게임 내 표시 이름(닉네임)을 변경합니다',
    currentName: '현재 이름',
    displayName: '닉네임',
    displayNamePlaceholder: '새 이름 입력 (3-20자)',
    firstRenameFree: '첫 번째改名 무료',
    renameCost: '改名 비용',
    renameCount: '{count}회改名 완료',
    saveName: '이름 저장',
    nameLengthError: '이름은 3-20자 사이여야 합니다',
    nameSameError: '새 이름이 현재 이름과 동일합니다',
    profileSaved: '이름이 변경되었습니다',
    profileSaveFailed: '이름 변경에 실패했습니다',
    nameChangedNotice: '플레이어 {oldName}님이 {newName}으로改名했습니다',
    about: '정보',
    version: '버전',
    checkUpdate: '업데이트 확인',
    checking: '확인 중...',
  ...
  trader: {
    title: '자원 거래소',
    exchangeRates: '환율 안내',
    exchangeRatesDesc: '암흑 물질로 기본 자원을 교환하세요',
    feeNotice: '거래당 {fee}% 수수료',
    tradePanel: '거래 패널',
    currentDarkMatter: '현재 암흑 물질',
    darkMatterAmount: '암흑 물질 수량',
    enterAmount: '수량 입력',
    maxTrade: '1회 거래 한도',
    preview: '거래 미리보기 (수수료 공제 후)',
    fee: '수수료',
    noPlanet: '먼저 행성을 선택해주세요',
    history: '거래 기록',
    noHistory: '거래 기록 없음'
  },
  bookmark: {
    ...
    all: '전체',
    starred: '즐겨찾기',
    empty: '북마크가 없습니다. 오른쪽 상단을 클릭하여 추가하세요.',
    name: '이름',
    namePlaceholder: '북마크 이름 입력',
    galaxy: '은하',
    system: '항성계',
    position: '위치',
    category: '카테고리',
  ...
  tutorial: {
    ...
    finish: '완료',
    steps: {
      welcome: { title: 'Infinite Stars에 오신 것을 환영합니다', content: '제국을 건설하고, 기술을 연구하고, 함대를 지휘하는 우주 전략 게임입니다. 기본 조작법을 빠르게 알아보겠습니다.' },
      overview: { title: '행성 개요', content: '행성 정보, 자원 생산량 및 건설 대기열이 표시됩니다.' },
      buildSolar: { title: '태양광 발전소 건설', content: '태양광 발전소는 에너지의 기반입니다. 다른 시설에 전력을 공급하기 위해 먼저 건설하세요.' },
      buildMetal: { title: '금속 광산 건설', content: '금속은 가장 기본적인 자원으로, 대부분의 건물과 함선에 사용됩니다.' },
      buildCrystal: { title: '크리스탈 광산 건설', content: '크리스탈은 연구와 고급 함선 건설에 사용됩니다.' },
      researchLab: { title: '연구 실험실 건설', content: '기술 연구를 해제하려면 연구 실험실이 필요합니다.' },
      researchTech: { title: '기술 연구', content: '여기서 다양한 기술을 연구하여 함대와 생산 효율을 향상시키세요.' },
      shipyard: { title: '조선소', content: '함선과 방어 시설을 건설하는 곳입니다.' },
      galaxy: { title: '은하 보기', content: '우주를 탐험하고 다른 플레이어와 자원을 발견하세요.' },
      checkin: { title: '일일 체크인', content: '매일 체크인하여 보상을 받으세요. 연속 체크인 시 더 좋은 보상을 드립니다!' },
      complete: { title: '튜토리얼 완료', content: '이제 기본 사항을 알았습니다. 우주 제국을 건설하러 가세요!' }
    }
  },
  sound: {
    title: '소리 설정',
    soundEnabled: '효과음 사용',
    musicEnabled: '배경 음악 사용',
    soundVolume: '효과음 볼륨',
    musicVolume: '음악 볼륨',
    testSound: '소리 테스트',
    bgmTrack: 'BGM 트랙',
  ...
  statistics: {
    ...
    buildings: '건물',
    research: '연구',
    fleetAndCombat: '함대 & 전투',
    trade: '거래',
    checkIn: '체크인',
    empire: '제국 개요',
    totalBuildings: '총 건물 수',
    totalBuildingLevels: '총 건물 레벨',
    buildingScore: '건물 점수',
    totalResearch: '총 연구 수',
    totalResearchLevels: '총 연구 레벨',
    researchScore: '연구 점수',
    totalShips: '총 함선 수',
    fleetDispatches: '함대 파견 횟수',
    battlesWon: '전투 승리',
    battlesLost: '전투 패배',
    winRate: '승률',
    totalTrades: '총 거래 횟수',
    darkMatterSpent: '사용한 암흑 물질',
    totalCheckInDays: '총 체크인 일수',
    currentStreak: '현재 연속 체크인',
    planets: '행성 수',
    moons: '위성 수',
    accountAge: '계정 일수',
    bookmarks: '북마크 수'
  ...
  battleReports: {
    ...
    prevPage: '이전',
    nextPage: '다음',
    unknownOpponent: '알 수 없는 적',
    attackerTechs: '공격측 기술',
    defenderTechs: '방어측 기술',
    weaponTech: '무기',
    shieldTech: '방패',
    armorTech: '장갑',
    initialPower: '초기 전력',
  ...
  queueManagement: {
    ...
    activeQueue: '활성 대기열',
    waitingQueue: '대기 대기열',
    emptyActive: '진행 중인 건설 작업 없음',
    emptyWaiting: '대기 대기열이 비어 있습니다',
    cancel: '취소',
    building: '건축',
    ship: '함선',
    defense: '방어',
  ...
  alliance: {
    ...
    noAlliance: '동맹에 참여하지 않았습니다',
    joinAlliance: '동맹 참여',
    requestToJoin: '참여 신청',
    invitePlayer: '플레이어 초대',
    leave: '동맹 탈퇴',
    leaveConfirm: '동맹을 탈퇴하시겠습니까?',
    disband: '동맹 해산',
    disbandConfirm: '동맹을 해산하시겠습니까? 모든 멤버가 제거됩니다.',
    promote: '승진',
    demote: '강등',
    kick: '추방',
    ...
    memberSince: '가입일',
    lastSeen: '마지막 접속',
    namePlaceholder: '동맹 이름 입력',
    tagPlaceholder: '예: ABC',
    tagHint: '3-8자의 영문자 또는 숫자',
    noResults: '동맹을 찾을 수 없습니다',
  ...
  chat: {
    ...
    dnd: {
      title: '방해 금지',
      none: '끄기',
      mute_world: '월드 채널 음소거',
      mute_alliance: '동맹 채널 음소거',
      mute_all: '전체 음소거'
    },
    newMessage: '님이 새 메시지를 보냈습니다',
    noMessages: '메시지가 없습니다'
  },

  recharge: {
    title: '암흑 물질 충전',
    mockNotice: '테스트 모드 — 구매 클릭 시 결제가 시뮬레이션됩니다',
    tabRecharge: '충전',
    tabMonthly: '월정액',
    tabGifts: '선물 팩',
    buy: '구매',
    firstBonus: '첫 충전 보너스',
    bonus: '보너스',
    purchaseSuccess: '충전 성공! {amount} 암흑 물질 획득',
    dailyClaimTitle: '일일 암흑 물질 수령',
    dailyClaimDesc: '월정액이 활성화되어 있습니다 — 오늘의 무료 암흑 물질을 수령하세요',
    claim: '수령',
    claimed: '수령 완료',
    dailyClaimSuccess: '수령 성공! {amount} 암흑 물질 획득',
    buyCard: '카드 구매',
    active: '활성',
    expiresIn: '{days}일 남음',
    day: '일',
    cardPurchaseSuccess: '월정액 카드 구매 완료!',
    perks: {
    ...
    unavailable: '구매 불가',
    buyGift: '팩 구매',
    noGifts: '구매 가능한 선물 팩이 없습니다',
    giftPurchaseSuccess: '선물 팩 구매 완료!'
  },

  accelerate: {
    title: '가속',
    cost: '비용: {amount} 암흑 물질',
    confirm: '확인',
    remaining: '남은 시간',
    skipTime: '건너뛰기',
  ...
  growthFund: {
    title: '성장 펀드',
    heroTitle: '성장 펀드 — 장기 투자 플랜',
    heroDesc: '한 번 구매하면 플레이 진행에 따라 최대 22,000 다크매터를 단계별로 획득!',
    totalReturn: '총 환급',
    cost: '가격',
    howItWorks: '구매 후 다크매터를 소비하면 포인트가 적립됩니다. 각 단계의 포인트 요구치에 도달하면 DM 보상을 받을 수 있습니다.',
    buyButton: '성장 펀드 구매',
    buySuccess: '성장 펀드를 구매했습니다!',
    buyFailed: '구매 실패',
    claimed: '수령 완료',
    remaining: '잔여',
    myPoints: '내 포인트',
    nextStage: '다음 단계 진행',
    nextStageReward: '달성 시 {amount} 다크매터 획득',
    allClaimed: '모든 보상을 수령했습니다!',
    totalClaimedAmount: '누적 수령: {amount} DM',
    stages: '보상 단계',
    claim: '수령',
    loadFailed: '성장 펀드 로드 실패',
    claimSuccess: '수령 성공! {amount} 다크매터 획득',
    claimFailed: '수령 실패',
    pointsReq: '{points} 포인트 필요',
    reward: '보상: {amount} DM',
    statusClaimed: '수령 완료',
