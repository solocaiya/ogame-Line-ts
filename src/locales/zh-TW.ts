export default {
  ...
  trader: {
    title: '資源交易所',
    exchangeRates: '匯率說明',
    exchangeRatesDesc: '使用暗物質兌換基礎資源',
    feeNotice: '每筆交易收取 {fee}% 手續費',
    tradePanel: '交易面板',
    currentDarkMatter: '當前暗物質',
    darkMatterAmount: '暗物質數量',
    enterAmount: '輸入數量',
    maxTrade: '單筆上限',
    preview: '交易預覽（扣除手續費後）',
    fee: '手續費',
  ...
  bookmark: {
    ...
    empty: '暫無書籤，點擊右上角添加',
    name: '名稱',
    namePlaceholder: '輸入書籤名稱',
    galaxy: '銀河',
    system: '星系',
    position: '位置',
    category: '分類',
    note: '備註',
    notePlaceholder: '輸入備註內容',
    color: '顏色標記',
    added: '書籤已添加',
    updated: '書籤已更新',
    deleted: '書籤已刪除',
  ...
  tutorial: {
    ...
    finish: '完成引導',
    steps: {
      welcome: { title: '歡迎來到無限星辰', content: '這是一個宇宙策略遊戲，你將建立帝國、發展科技、組建艦隊。讓我們快速了解一下基本玩法。' },
      overview: { title: '星球總覽', content: '這裡顯示你的星球基本資訊、資源產量和建築隊列。' },
      buildSolar: { title: '建造太陽能電站', content: '太陽能電站是能源的基礎，先建造它來為其他設施供電。' },
      buildMetal: { title: '建造金屬礦', content: '金屬是最基礎的資源，用於建造大部分建築和艦船。' },
      buildCrystal: { title: '建造水晶礦', content: '水晶用於研究科技和建造高級艦船。' },
      researchLab: { title: '建造研究實驗室', content: '有了研究實驗室才能解鎖科技研究。' },
      researchTech: { title: '科技研究', content: '在這裡研究各種科技，提升艦隊戰鬥力和生產效率。' },
      shipyard: { title: '船塢', content: '建造艦船和防禦設施的地方。' },
      galaxy: { title: '星系視圖', content: '探索宇宙，發現其他玩家和可用資源。' },
      checkin: { title: '每日簽到', content: '每天簽到領取獎勵，連續簽到獎勵更豐厚！' },
      complete: { title: '引導完成', content: '你已經了解了基本玩法，現在去建立你的宇宙帝國吧！' }
    }
  },
  sound: {
    title: '音效設定',
  ...
  statistics: {
    ...
    buildings: '建築統計',
    research: '科技統計',
    fleetAndCombat: '艦隊與戰鬥',
    trade: '交易統計',
    checkIn: '簽到統計',
    empire: '帝國概況',
    totalBuildings: '建築總數',
    totalBuildingLevels: '建築總等級',
    buildingScore: '建築得分',
    totalResearch: '科技總數',
    totalResearchLevels: '科技總等級',
    researchScore: '科技得分',
    totalShips: '艦船總數',
    fleetDispatches: '艦隊派遣次數',
    battlesWon: '戰鬥勝利',
    battlesLost: '戰鬥失敗',
    winRate: '勝率',
    totalTrades: '交易總次數',
    darkMatterSpent: '暗物質消費',
    totalCheckInDays: '累計簽到天數',
    currentStreak: '當前連續簽到',
    planets: '星球數量',
    moons: '月球數量',
    accountAge: '帳號天數',
    bookmarks: '書籤數量'
