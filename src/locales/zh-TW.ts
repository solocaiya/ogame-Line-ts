export default {
  ...
  settings: {
    ...
    reset: '重置',
    profile: '個人資料',
    profileDesc: '修改遊戲中顯示的名稱（暱稱）',
    currentName: '當前的名稱',
    displayName: '暱稱',
    displayNamePlaceholder: '請輸入新暱稱（3-20個字符）',
    firstRenameFree: '首次改名免費',
    renameCost: '改名費用',
    renameCount: '已改名 {count} 次',
    saveName: '儲存暱稱',
    nameLengthError: '暱稱長度需在3-20個字符之間',
    nameSameError: '新暱稱與當前暱稱相同',
    profileSaved: '暱稱修改成功',
    profileSaveFailed: '暱稱修改失敗',
    nameChangedNotice: '玩家 {oldName} 已改名為 {newName}',
    about: '關於',
    version: '版本',
    latestVersion: '最新版本',
    checkUpdate: '檢查更新',
  ...
  alliance: {
    ...
    settings: '設定',
    search: '搜尋聯盟',
    searchPlaceholder: '按名稱或標籤搜尋...',
    noAlliance: '你還沒有加入聯盟',
    joinAlliance: '加入聯盟',
    requestToJoin: '申請加入',
    invitePlayer: '邀請玩家',
    leave: '離開聯盟',
    leaveConfirm: '確定要離開聯盟嗎？',
    disband: '解散聯盟',
    disbandConfirm: '確定要解散聯盟嗎？所有成員將被移除。',
    promote: '晉升',
    demote: '降級',
    kick: '踢出',
    kickConfirm: '確定要踢出 {name} 嗎？',
    role: {
      leader: '領袖',
      officer: '官員',
      member: '成員'
    ...
    maxMembers: '最大成員數',
    autoAccept: '自動接受',
    requireApproval: '需要審批',
    saveSettings: '儲存設定',
    requestMessage: '申請留言（可選）',
    accept: '接受',
    reject: '拒絕',
  ...
  recharge: {
    title: '暗物質儲值',
    mockNotice: '目前為測試模式，點擊購買即模擬完成支付',
    tabRecharge: '儲值',
    tabMonthly: '月卡',
    tabGifts: '禮包',
    buy: '購買',
    firstBonus: '首儲獎勵',
    bonus: '贈送',
    purchaseSuccess: '儲值成功！獲得 {amount} 暗物質',
    dailyClaimTitle: '每日暗物質領取',
    dailyClaimDesc: '您已激活月卡，今日可領取免費暗物質',
    claim: '領取',
    claimed: '已領取',
    dailyClaimSuccess: '領取成功！獲得 {amount} 暗物質',
    buyCard: '購買月卡',
    active: '已激活',
    expiresIn: '剩餘 {days} 天',
    day: '天',
    cardPurchaseSuccess: '月卡購買成功！',
    perks: {
  ...
  growthFund: {
    title: '成長基金',
    heroTitle: '成長基金 — 長期投資計畫',
    heroDesc: '一次性購買成長基金，隨著遊戲進度逐步領取總計 22,000 暗物質獎勵！',
    totalReturn: '總返還',
    cost: '價格',
    howItWorks: '購買後，透過消費暗物質累積積分。積分達到各階段要求時，即可領取對應暗物質獎勵。',
    buyButton: '購買成長基金',
    buySuccess: '成長基金購買成功！',
    buyFailed: '購買失敗',
    claimed: '已領取',
    ...
    myPoints: '我的積分',
    nextStage: '下一階段進度',
    nextStageReward: '達成後可領取 {amount} 暗物質',
    allClaimed: '所有獎勵已領取！',
    totalClaimedAmount: '累計領取 {amount} 暗物質',
    stages: '獎勵階段',
    claim: '領取',
    loadFailed: '載入成長基金失敗',
    claimSuccess: '領取成功！獲得 {amount} 暗物質',
    claimFailed: '領取失敗',
    pointsReq: '需要 {points} 積分',
    reward: '獎勵 {amount} DM',
    statusClaimed: '已領取',
    statusClaimable: '可領取',
    statusLocked: '未達成'
