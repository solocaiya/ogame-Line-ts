export default {
  ...
  nav: {
    ...
    battleReports: 'Informes',
    queueManagement: 'Cola',
    gm: 'GM',
    alliance: 'Alianza'
  },
  sidebar: {
  ...
  settings: {
    ...
    reset: 'Reiniciar',
    profile: 'Perfil',
    profileDesc: 'Cambia tu nombre visible en el juego',
    currentName: 'Nombre actual',
    displayName: 'Nombre visible',
    displayNamePlaceholder: 'Ingresa nuevo nombre (3-20 caracteres)',
    firstRenameFree: 'Primer cambio gratis',
    renameCost: 'Costo de cambio',
    renameCount: 'Cambiado {count} veces',
    saveName: 'Guardar nombre',
    nameLengthError: 'El nombre debe tener entre 3 y 20 caracteres',
    nameSameError: 'El nuevo nombre es igual al actual',
    profileSaved: 'Nombre cambiado exitosamente',
    profileSaveFailed: 'Error al cambiar el nombre',
    nameChangedNotice: 'El jugador {oldName} ahora se llama {newName}',
    about: 'Acerca de',
    version: 'Versión',
  ...
  trader: {
    title: 'Comercio de Recursos',
    exchangeRates: 'Tasas de Cambio',
    exchangeRatesDesc: 'Intercambia materia oscura por recursos básicos',
    feeNotice: '{fee}% de comisión por transacción',
    tradePanel: 'Panel de Comercio',
    currentDarkMatter: 'Materia Oscura Actual',
    darkMatterAmount: 'Cantidad de Materia Oscura',
    enterAmount: 'Ingrese cantidad',
    maxTrade: 'Máximo por comercio',
    preview: 'Vista previa (después de comisión)',
    fee: 'Comisión',
    noPlanet: 'Selecciona un planeta primero',
    history: 'Historial de Comercio',
    noHistory: 'Sin historial de comercio'
  },
  bookmark: {
    title: 'Marcadores',
    ...
    all: 'Todos',
    starred: 'Favoritos',
    empty: 'Sin marcadores. Haz clic arriba a la derecha para agregar uno.',
    name: 'Nombre',
    namePlaceholder: 'Ingrese nombre del marcador',
    galaxy: 'Galaxia',
    system: 'Sistema',
    position: 'Posición',
    category: 'Categoría',
  ...
  tutorial: {
    ...
    finish: 'Finalizar',
    steps: {
      welcome: { title: 'Bienvenido a Infinite Stars', content: 'Este es un juego de estrategia espacial donde construyes un imperio, investigas tecnología y comandas flotas. Repasemos lo básico rápidamente.' },
      overview: { title: 'Vista del Planeta', content: 'Aquí ves la info de tu planeta, producción de recursos y cola de construcción.' },
      buildSolar: { title: 'Construir Planta Solar', content: 'La planta solar es tu base de energía. Constrúyela primero para alimentar otras instalaciones.' },
      buildMetal: { title: 'Construir Mina de Metal', content: 'El metal es el recurso más básico, usado para la mayoría de edificios y naves.' },
      buildCrystal: { title: 'Construir Mina de Cristal', content: 'El cristal se usa para investigación y construcción de naves avanzadas.' },
      researchLab: { title: 'Construir Laboratorio', content: 'Necesitas un laboratorio de investigación para desbloquear tecnologías.' },
      researchTech: { title: 'Investigación', content: 'Investiga tecnologías aquí para mejorar tu flota y eficiencia de producción.' },
      shipyard: { title: 'Astillero', content: 'Construye naves y instalaciones de defensa aquí.' },
      galaxy: { title: 'Vista Galáctica', content: 'Explora el universo y descubre otros jugadores y recursos.' },
      checkin: { title: 'Registro Diario', content: 'Regístrate diariamente para obtener recompensas. ¡Registros consecutivos dan mejores recompensas!' },
      complete: { title: 'Tutorial Completo', content: 'Ya conoces lo básico. ¡Ve a construir tu imperio cósmico!' }
    }
  },
  sound: {
    title: 'Configuración de Sonido',
    soundEnabled: 'Activar Efectos de Sonido',
    musicEnabled: 'Activar Música de Fondo',
    soundVolume: 'Volumen de SFX',
    musicVolume: 'Volumen de Música',
    testSound: 'Probar Sonido',
    bgmTrack: 'Pista de Música',
    bgmTracks: {
  ...
  statistics: {
    ...
    buildings: 'Edificios',
    research: 'Investigación',
    fleetAndCombat: 'Flota y Combate',
    trade: 'Comercio',
    checkIn: 'Registro',
    empire: 'Resumen del Imperio',
    totalBuildings: 'Total de Edificios',
    totalBuildingLevels: 'Niveles de Edificios',
    buildingScore: 'Puntos de Edificios',
    totalResearch: 'Total de Investigaciones',
    totalResearchLevels: 'Niveles de Investigación',
    researchScore: 'Puntos de Investigación',
    totalShips: 'Total de Naves',
    fleetDispatches: 'Envíos de Flota',
    battlesWon: 'Batallas Ganadas',
    battlesLost: 'Batallas Perdidas',
    winRate: 'Tasa de Victoria',
    totalTrades: 'Total de Comercios',
    darkMatterSpent: 'Materia Oscura Gastada',
    totalCheckInDays: 'Días de Registro',
    currentStreak: 'Racha Actual',
    planets: 'Planetas',
    moons: 'Lunas',
    accountAge: 'Antigüedad (días)',
    bookmarks: 'Marcadores'
  },
  battleReports: {
    ...
    thisMonth: 'Este mes',
    noReports: 'Sin informes de batalla',
    lossShort2: 'Pérdidas',
    rounds: 'rondas',
    prevPage: 'Anterior',
    nextPage: 'Siguiente',
    unknownOpponent: 'Oponente desconocido',
    attackerTechs: 'Tecnología atacante',
    defenderTechs: 'Tecnología defensora',
    weaponTech: 'Armas',
    shieldTech: 'Escudo',
    armorTech: 'Blindaje',
  ...
  queueManagement: {
    ...
    waitingQueue: 'Cola en espera',
    emptyActive: 'No hay tareas de construcción activas',
    emptyWaiting: 'La cola en espera está vacía',
    cancel: 'Cancelar',
    building: 'Edificio',
    ship: 'Nave',
    defense: 'Defensa',
    ...
    planet: 'Planeta',
    status: 'Estado',
    estimatedTime: 'Finalización est.',
  ...
  alliance: {
    ...
    name: 'Nombre de la Alianza',
    tag: 'Etiqueta de la Alianza',
    description: 'Descripción',
    members: 'Miembros',
    requests: 'Solicitudes',
    settings: 'Configuración',
    search: 'Buscar Alianzas',
    searchPlaceholder: 'Buscar por nombre o etiqueta...',
    noAlliance: 'No estás en una alianza',
    joinAlliance: 'Unirse a Alianza',
    requestToJoin: 'Solicitar unirse',
    invitePlayer: 'Invitar jugador',
    leave: 'Salir de la Alianza',
    leaveConfirm: '¿Estás seguro de que quieres salir de la alianza?',
    disband: 'Disolver Alianza',
    disbandConfirm: '¿Estás seguro? Todos los miembros serán eliminados.',
    promote: 'Promover',
    demote: 'Degradar',
    kick: 'Expulsar',
    kickConfirm: '¿Estás seguro de que quieres expulsar a {name}?',
    role: {
      leader: 'Líder',
      officer: 'Oficial',
      member: 'Miembro'
    ...
    requestMessage: 'Mensaje (opcional)',
    accept: 'Aceptar',
    reject: 'Rechazar',
    ...
    lastSeen: 'Última vez',
    namePlaceholder: 'Nombre de la alianza',
    tagPlaceholder: 'ej. ABC',
    tagHint: '3-8 letras o números',
    noResults: 'No se encontraron alianzas',
  ...
  chat: {
    ...
    dnd: {
      title: 'No molestar',
      none: 'Desactivado',
      mute_world: 'Silenciar canal mundial',
      mute_alliance: 'Silenciar canal de alianza',
      mute_all: 'Silenciar todo'
    },
    newMessage: 'envió un nuevo mensaje',
    noMessages: 'Aún no hay mensajes'
  },

  recharge: {
    title: 'Recargar Materia Oscura',
    mockNotice: 'Modo de prueba — hacer clic en comprar simula el pago',
    tabRecharge: 'Recargar',
    tabMonthly: 'Tarjeta Mensual',
    tabGifts: 'Paquetes de Regalo',
    buy: 'Comprar',
    firstBonus: 'Primer Bonus',
    bonus: 'Bonus',
    purchaseSuccess: '¡Recarga exitosa! Has recibido {amount} Materia Oscura',
    dailyClaimTitle: 'Reclamo Diario de Materia Oscura',
    dailyClaimDesc: 'Tienes una tarjeta mensual activa — reclama materia oscura gratis hoy',
    claim: 'Reclamar',
    claimed: 'Reclamado',
    dailyClaimSuccess: '¡Reclamo exitoso! Has recibido {amount} Materia Oscura',
    buyCard: 'Comprar Tarjeta',
    active: 'Activa',
    expiresIn: '{days} días restantes',
    day: 'día',
    cardPurchaseSuccess: '¡Tarjeta mensual comprada!',
    perks: {
    ...
    buyGift: 'Comprar Paquete',
    noGifts: 'No hay paquetes de regalo disponibles',
    giftPurchaseSuccess: '¡Paquete de regalo comprado!'
  },

  accelerate: {
    title: 'Acelerar',
    cost: 'Costo: {amount} Materia Oscura',
    confirm: 'Confirmar',
    remaining: 'Restante',
    skipTime: 'Saltar',
    ...
    research: 'Acelerar investigación',
    shipBuild: 'Acelerar construcción',
    fleetTravel: 'Acelerar flota',
  ...
  growthFund: {
    title: 'Fondo de Crecimiento',
    heroTitle: 'Fondo de Crecimiento — Inversión a Largo Plazo',
    heroDesc: '¡Compra una vez y reclama progresivamente hasta 22,000 Materia Oscura mientras juegas!',
    totalReturn: 'Retorno Total',
    cost: 'Precio',
    howItWorks: 'Después de comprar, gana puntos gastando Materia Oscura. Alcanza metas de puntos para reclamar recompensas de DM en cada etapa.',
    buyButton: 'Comprar Fondo',
    buySuccess: '¡Fondo de Crecimiento comprado!',
    buyFailed: 'Compra fallida',
    claimed: 'Reclamado',
    remaining: 'Restante',
    myPoints: 'Mis Puntos',
    nextStage: 'Progreso a la Siguiente Etapa',
    nextStageReward: 'Reclama {amount} Materia Oscura al completar',
    allClaimed: '¡Todas las recompensas reclamadas!',
    totalClaimedAmount: 'Total reclamado: {amount} DM',
    stages: 'Etapas de Recompensas',
    claim: 'Reclamar',
    loadFailed: 'Error al cargar el Fondo de Crecimiento',
    claimSuccess: '¡Reclamado! {amount} Materia Oscura recibida',
    claimFailed: 'Reclamo fallido',
    pointsReq: 'Requiere {points} puntos',
