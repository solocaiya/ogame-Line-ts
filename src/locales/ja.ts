export default {
  ...
  settings: {
    ...
    reset: 'リセット',
    profile: 'プロフィール',
    profileDesc: 'ゲーム内の表示名（ニックネーム）を変更します',
    currentName: '現在の名前',
    displayName: 'ニックネーム',
    displayNamePlaceholder: '新しい名前を入力（3〜20文字）',
    firstRenameFree: '初回改名無料',
    renameCost: '改名費用',
    renameCount: '{count}回改名済み',
    saveName: '名前を保存',
    nameLengthError: '名前は3〜20文字で入力してください',
    nameSameError: '新しい名前が現在の名前と同じです',
    profileSaved: '名前を変更しました',
    profileSaveFailed: '名前の変更に失敗しました',
    nameChangedNotice: 'プレイヤー {oldName} は {newName} に改名しました',
    about: 'について',
    version: 'バージョン',
  ...
  privacy: {
    ...
    sections: {
      introduction: {
        title: 'はじめに',
        content:
          'このプライバシーポリシーは、Infinite Starsがお客様のデータをどのように取り扱うかを説明しています。私たちはお客様のプライバシーの保護に取り組んでおり、このゲームはユーザーのプライバシーを完全に尊重して設計されています。'
      },
      dataCollection: {
        title: 'データ収集',
  ...
  tutorial: {
    ...
    mobile: {
      welcome: {
        title: 'Infinite Starsへようこそ（モバイル版）',
        content:
  ...
  trader: {
    title: '資源取引所',
    exchangeRates: 'レート説明',
    exchangeRatesDesc: 'ダークマターで基本資源を交換',
    feeNotice: '取引ごとに{fee}%の手数料',
    tradePanel: '取引パネル',
    currentDarkMatter: '現在のダークマター',
    darkMatterAmount: 'ダークマター数量',
    enterAmount: '数量を入力',
    maxTrade: '1回の取引上限',
    preview: '取引プレビュー（手数料控除後）',
    fee: '手数料',
    noPlanet: '先に惑星を選択してください',
    history: '取引履歴',
    noHistory: '取引履歴なし'
  },
  bookmark: {
    ...
    all: 'すべて',
    starred: 'お気に入り',
    empty: 'ブックマークがありません。右上をクリックして追加してください。',
    name: '名前',
    namePlaceholder: 'ブックマーク名を入力',
    galaxy: '銀河',
    system: '星系',
    position: '位置',
    category: 'カテゴリ',
  ...
  tutorial: {
    ...
    finish: '完了',
    steps: {
      welcome: { title: 'Infinite Starsへようこそ', content: '帝国を建設し、技術を研究し、艦隊を指揮する宇宙戦略ゲームです。基本的な玩法を簡単にご紹介します。' },
      overview: { title: '惑星概要', content: '惑星の基本情報、資源生産量、建築キューが表示されます。' },
      buildSolar: { title: '太陽光発電所を建設', content: '太陽光発電所はエネルギーの基盤です。最初に建設して他の施設に電力を供給しましょう。' },
      buildMetal: { title: '金属鉱山を建設', content: '金属は最も基本的な資源で、ほとんどの建物や艦船に使用されます。' },
      buildCrystal: { title: 'クリスタル鉱山を建設', content: 'クリスタルは技術研究や高級艦船の建造に使用されます。' },
      researchLab: { title: '研究ラボを建設', content: '研究ラボがあると技術研究をアンロックできます。' },
      researchTech: { title: '技術研究', content: 'ここで様々な技術を研究し、艦隊の戦闘力と生産効率を向上させましょう。' },
      shipyard: { title: '造船所', content: '艦船や防御施設を建造する場所です。' },
      galaxy: { title: '銀河ビュー', content: '宇宙を探索し、他のプレイヤーや利用可能な資源を発見しましょう。' },
      checkin: { title: '毎日チェックイン', content: '毎日チェックインして報酬をもらいましょう。連続チェックインでより豊富な報酬！' },
      complete: { title: 'チュートリアル完了', content: '基本的な玩法を理解しました。さあ、宇宙帝国を建設しましょう！' }
    }
  },
  sound: {
    title: 'サウンド設定',
    soundEnabled: '効果音を有効にする',
    musicEnabled: 'BGMを有効にする',
    soundVolume: '効果音ボリューム',
    musicVolume: '音楽ボリューム',
    testSound: 'サウンドテスト',
    bgmTrack: 'BGMトラック',
    bgmTracks: {
  ...
  statistics: {
    ...
    buildings: '建築統計',
    research: '技術統計',
    fleetAndCombat: '艦隊と戦闘',
    trade: '取引統計',
    checkIn: 'チェックイン統計',
    empire: '帝国概要',
    totalBuildings: '建築総数',
    totalBuildingLevels: '建築総レベル',
    buildingScore: '建築スコア',
    totalResearch: '技術総数',
    totalResearchLevels: '技術総レベル',
    researchScore: '技術スコア',
    totalShips: '艦船総数',
    fleetDispatches: '艦隊派遣回数',
    battlesWon: '戦闘勝利',
    battlesLost: '戦闘敗北',
    winRate: '勝率',
    totalTrades: '取引総回数',
    darkMatterSpent: 'ダークマター消費',
    totalCheckInDays: '累計チェックイン日数',
    currentStreak: '現在の連続チェックイン',
    planets: '惑星数',
    moons: '衛星数',
    accountAge: 'アカウント日数',
    bookmarks: 'ブックマーク数'
  ...
  queueManagement: {
    ...
    waitingQueue: '待機キュー',
    emptyActive: '進行中の建設タスクはありません',
    emptyWaiting: '待機キューは空です',
    cancel: 'キャンセル',
    building: '建物',
    ship: '艦船',
    defense: '防衛',
  ...
  alliance: {
    ...
    settings: '設定',
    search: '同盟を検索',
    searchPlaceholder: '名前またはタグで検索...',
    noAlliance: '同盟に参加していません',
    joinAlliance: '同盟に参加',
    requestToJoin: '参加申請',
    invitePlayer: 'プレイヤーを招待',
    leave: '同盟を脱退',
    leaveConfirm: '同盟を脱退しますか？',
    disband: '同盟を解散',
    disbandConfirm: '同盟を解散しますか？全メンバーが削除されます。',
    promote: '昇格',
    demote: '降格',
    kick: 'キック',
    ...
    maxMembers: '最大メンバー数',
    autoAccept: '自動承認',
    requireApproval: '承認必要',
    saveSettings: '設定を保存',
    requestMessage: 'メッセージ（任意）',
    accept: '承認',
    reject: '拒否',
    ...
    memberSince: '加入日',
    lastSeen: '最終オンライン',
    namePlaceholder: '同盟名を入力',
    tagPlaceholder: '例：ABC',
    tagHint: '3〜8文字の英数字',
    noResults: '同盟が見つかりません',
  ...
  chat: {
    ...
    dnd: {
      title: '通知オフ',
      none: 'オフ',
      mute_world: 'ワールドチャンネルをミュート',
      mute_alliance: '同盟チャンネルをミュート',
      mute_all: 'すべてミュート'
    },
    newMessage: 'が新しいメッセージを送信しました',
    noMessages: 'メッセージはまだありません'
  },

  recharge: {
    title: 'ダークマターチャージ',
    mockNotice: 'テストモード — 購入クリックで支払いをシミュレートします',
    tabRecharge: 'チャージ',
    tabMonthly: '月額カード',
    tabGifts: 'ギフトパック',
    buy: '購入',
    firstBonus: '初回ボーナス',
    bonus: 'ボーナス',
    purchaseSuccess: 'チャージ成功！{amount} ダークマターを獲得',
    dailyClaimTitle: '毎日ダークマター受取',
    dailyClaimDesc: '月額カードが有効です — 本日の無料ダークマターを受け取れます',
    claim: '受取',
    claimed: '受取済み',
    dailyClaimSuccess: '受取成功！{amount} ダークマターを獲得',
    buyCard: 'カード購入',
    active: '有効',
    expiresIn: '残り {days} 日',
    day: '日',
    cardPurchaseSuccess: '月額カードを購入しました！',
    perks: {
    ...
    unavailable: '利用不可',
    buyGift: 'パック購入',
    noGifts: '利用可能なギフトパックはありません',
    giftPurchaseSuccess: 'ギフトパックを購入しました！'
  },

  accelerate: {
    title: '加速',
    cost: 'コスト: {amount} ダークマター',
    confirm: '確認',
    remaining: '残り時間',
    skipTime: 'スキップ',
  ...
  growthFund: {
    title: '成長ファンド',
    heroTitle: '成長ファンド — 長期投資プラン',
    heroDesc: '一度購入するだけで、プレイの進展に応じて最大22,000ダークマテリアを段階的に獲得！',
    totalReturn: '総還元',
    cost: '価格',
    howItWorks: '購入後、ダークマテリアを使うとポイントが貯まります。ポイントが各ステージの要件に達すると、DM報酬を獲得できます。',
    buyButton: '成長ファンドを購入',
    buySuccess: '成長ファンドを購入しました！',
    buyFailed: '購入に失敗しました',
    claimed: '受取済み',
    remaining: '残り',
    myPoints: 'マイポイント',
    nextStage: '次のステージ進捗',
    nextStageReward: '達成すると {amount} ダークマテリアを獲得',
    allClaimed: '全ての報酬を受取りました！',
    totalClaimedAmount: '累計受取額: {amount} DM',
    stages: '報酬ステージ',
    claim: '受取る',
    loadFailed: '成長ファンドの読み込みに失敗しました',
    claimSuccess: '受取成功！ {amount} ダークマテリアを獲得',
    claimFailed: '受取に失敗しました',
    pointsReq: '{points} ポイント必要',
    reward: '報酬: {amount} DM',
    statusClaimed: '受取済み',
