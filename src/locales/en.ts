export default {
  ...
  settings: {
    ...
    reset: 'Reset',
    profile: 'Profile',
    profileDesc: 'Change your in-game display name',
    currentName: 'Current name',
    displayName: 'Display name',
    displayNamePlaceholder: 'Enter new name (3-20 characters)',
    firstRenameFree: 'First rename is free',
    renameCost: 'Rename cost',
    renameCount: 'Renamed {count} times',
    saveName: 'Save name',
    nameLengthError: 'Name must be 3-20 characters',
    nameSameError: 'New name is the same as current name',
    profileSaved: 'Name changed successfully',
    profileSaveFailed: 'Failed to change name',
    nameChangedNotice: 'Player {oldName} is now known as {newName}',
    about: 'About',
    version: 'Version',
  ...
  trader: {
    ...
    exchangeRatesDesc: 'Trade dark matter for basic resources',
    feeNotice: '{fee}% fee per transaction',
    tradePanel: 'Trade Panel',
    currentDarkMatter: 'Current Dark Matter',
    darkMatterAmount: 'Dark Matter Amount',
    enterAmount: 'Enter amount',
    maxTrade: 'Max per trade',
    preview: 'Trade Preview (after fee)',
    fee: 'Fee',
    noPlanet: 'Please select a planet first',
  ...
  bookmark: {
    ...
    all: 'All',
    starred: 'Starred',
    empty: 'No bookmarks yet. Click the top right to add one.',
    name: 'Name',
  ...
  tutorial: {
    ...
    finish: 'Finish',
    steps: {
      welcome: { title: 'Welcome to Infinite Stars', content: 'This is a space strategy game where you build an empire, research tech, and command fleets. Let\'s quickly go over the basics.' },
      overview: { title: 'Planet Overview', content: 'Here you can see your planet info, resource production, and building queue.' },
      buildSolar: { title: 'Build Solar Plant', content: 'The solar plant is your energy foundation. Build it first to power other facilities.' },
      buildMetal: { title: 'Build Metal Mine', content: 'Metal is the most basic resource, used for most buildings and ships.' },
      buildCrystal: { title: 'Build Crystal Mine', content: 'Crystal is used for research and advanced ship construction.' },
      researchLab: { title: 'Build Research Lab', content: 'You need a research lab to unlock technology research.' },
      researchTech: { title: 'Research', content: 'Research technologies here to improve your fleet and production efficiency.' },
      shipyard: { title: 'Shipyard', content: 'Build ships and defense facilities here.' },
      galaxy: { title: 'Galaxy View', content: 'Explore the universe and discover other players and resources.' },
      checkin: { title: 'Daily Check-In', content: 'Check in daily for rewards. Consecutive check-ins give better rewards!' },
      complete: { title: 'Tutorial Complete', content: 'You now know the basics. Go build your cosmic empire!' }
    }
  },
  sound: {
    title: 'Sound Settings',
    soundEnabled: 'Enable Sound Effects',
    musicEnabled: 'Enable Background Music',
    soundVolume: 'SFX Volume',
    musicVolume: 'Music Volume',
    testSound: 'Test Sound',
    bgmTrack: 'Background Music Track',
    bgmTracks: {
      overview: 'Overview',
      building: 'Building',
      research: 'Research',
  ...
  statistics: {
    ...
    totalResearchLevels: 'Total Research Levels',
    ...
    darkMatterSpent: 'Dark Matter Spent',
    totalCheckInDays: 'Total Check-In Days',
  ...
  battleReports: {
    ...
    noReports: 'No battle reports yet',
    lossShort2: 'Loss',
    rounds: 'rounds',
    prevPage: 'Previous',
    nextPage: 'Next',
    unknownOpponent: 'Unknown Opponent',
    attackerTechs: 'Attacker Tech',
    defenderTechs: 'Defender Tech',
    weaponTech: 'Weapon',
    shieldTech: 'Shield',
    armorTech: 'Armor',
  ...
  queueManagement: {
    ...
    emptyActive: 'No active construction tasks',
    emptyWaiting: 'Waiting queue is empty',
    cancel: 'Cancel',
    building: 'Building',
    ship: 'Ship',
    defense: 'Defense',
  ...
  alliance: {
    ...
    requests: 'Requests',
    settings: 'Settings',
    search: 'Search Alliances',
    searchPlaceholder: 'Search by name or tag...',
    noAlliance: 'You are not in an alliance',
    joinAlliance: 'Join Alliance',
    requestToJoin: 'Request to Join',
    invitePlayer: 'Invite Player',
    leave: 'Leave Alliance',
    leaveConfirm: 'Are you sure you want to leave the alliance?',
    disband: 'Disband Alliance',
    disbandConfirm: 'Are you sure you want to disband? All members will be removed.',
    promote: 'Promote',
    demote: 'Demote',
    kick: 'Kick',
    ...
    requestMessage: 'Request Message (optional)',
    accept: 'Accept',
    reject: 'Reject',
    ...
    lastSeen: 'Last Seen',
    namePlaceholder: 'Enter alliance name',
    tagPlaceholder: 'e.g. ABC',
    tagHint: '3-8 letters or numbers',
    noResults: 'No alliances found',
  ...
  chat: {
    ...
    dnd: {
      ...
      none: 'Off',
      mute_world: 'Mute World Channel',
      mute_alliance: 'Mute Alliance Channel',
      mute_all: 'Mute All'
    },
    newMessage: 'sent a new message',
    noMessages: 'No messages yet'
  },

  recharge: {
    title: 'Dark Matter Recharge',
    mockNotice: 'Test mode — clicking buy simulates payment completion',
    tabRecharge: 'Recharge',
    tabMonthly: 'Monthly Card',
    tabGifts: 'Gift Packs',
    buy: 'Buy',
    firstBonus: 'First Bonus',
    bonus: 'Bonus',
    purchaseSuccess: 'Recharge successful! Received {amount} Dark Matter',
    dailyClaimTitle: 'Daily Dark Matter Claim',
    dailyClaimDesc: 'You have an active monthly card — claim free Dark Matter today',
    claim: 'Claim',
    claimed: 'Claimed',
    dailyClaimSuccess: 'Claimed successfully! Received {amount} Dark Matter',
    buyCard: 'Buy Card',
    active: 'Active',
    expiresIn: '{days} days remaining',
    day: 'day',
    cardPurchaseSuccess: 'Monthly card purchased!',
    perks: {
      ...
      research_queue_plus_1: 'Research Queue +1',
    ...
    buyGift: 'Buy Pack',
    noGifts: 'No gift packs available',
    giftPurchaseSuccess: 'Gift pack purchased!'
  },

  accelerate: {
    title: 'Accelerate',
    cost: 'Cost: {amount} Dark Matter',
    confirm: 'Confirm',
    remaining: 'Remaining',
    skipTime: 'Skip',
    ...
    shipBuild: 'Accelerate Ship Build',
    fleetTravel: 'Accelerate Fleet',
    defense: 'Accelerate Defense',
    hours: '{count}h',
    minutes: '{count}m',
    costDM: '{amount} DM',
    dailyCapRemaining: 'Daily cap remaining: {remaining} DM',
    dailyCapExceeded: 'Daily acceleration cap reached, {remaining} DM remaining'
  },

  growthFund: {
    title: 'Growth Fund',
    heroTitle: 'Growth Fund — Long-term Investment',
    heroDesc: 'Purchase the Growth Fund once and progressively claim up to 22,000 Dark Matter as you play!',
    totalReturn: 'Total Return',
    cost: 'Price',
    howItWorks: 'After purchase, earn points by spending Dark Matter. Reach point milestones to claim DM rewards at each stage.',
    buyButton: 'Buy Growth Fund',
    buySuccess: 'Growth Fund purchased!',
    buyFailed: 'Purchase failed',
    claimed: 'Claimed',
    remaining: 'Remaining',
    myPoints: 'My Points',
    nextStage: 'Next Stage Progress',
    nextStageReward: 'Claim {amount} Dark Matter upon completion',
    allClaimed: 'All rewards claimed!',
    totalClaimedAmount: 'Total claimed: {amount} DM',
    stages: 'Reward Stages',
    claim: 'Claim',
    loadFailed: 'Failed to load Growth Fund',
    claimSuccess: 'Claimed! Received {amount} Dark Matter',
    claimFailed: 'Claim failed',
    pointsReq: 'Requires {points} points',
