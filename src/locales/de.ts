export default {
  ...
  nav: {
    ...
    battleReports: 'Berichte',
    queueManagement: 'Warteschlange',
    gm: 'GM'
  },
  sidebar: {
  ...
  settings: {
    ...
    battleModeEnabled: 'Bis zum Ende kämpfen Modus aktiviert',
    battleModeDisabled: 'Bis zum Ende kämpfen Modus deaktiviert',
    pause: 'Pausieren',
    resume: 'Fortsetzen',
  ...
  trader: {
    title: 'Ressourcenhändler',
    exchangeRates: 'Wechselkurse',
    exchangeRatesDesc: 'Tausche Dunkle Materie gegen Grundressourcen',
    feeNotice: '{fee}% Gebühr pro Transaktion',
    tradePanel: 'Handelspanel',
    currentDarkMatter: 'Aktuelle Dunkle Materie',
    darkMatterAmount: 'Dunkle Materie Menge',
    enterAmount: 'Menge eingeben',
    maxTrade: 'Maximum pro Handel',
    preview: 'Handelsvorschau (nach Gebühr)',
    fee: 'Gebühr',
    noPlanet: 'Bitte wähle zuerst einen Planeten',
    history: 'Handelsverlauf',
    noHistory: 'Kein Handelsverlauf'
  },
  bookmark: {
    title: 'Lesezeichen',
    ...
    all: 'Alle',
    starred: 'Favoriten',
    empty: 'Keine Lesezeichen. Klicke oben rechts um eines hinzuzufügen.',
    name: 'Name',
    namePlaceholder: 'Lesezeichenname eingeben',
    galaxy: 'Galaxie',
    system: 'System',
    position: 'Position',
    category: 'Kategorie',
  ...
  tutorial: {
    ...
    finish: 'Fertig',
    steps: {
      welcome: { title: 'Willkommen bei Infinite Stars', content: 'Dies ist ein Weltraum-Strategiespiel, in dem du ein Imperium aufbaust, Technologien erforschst und Flotten kommandierst. Lass uns schnell die Grundlagen durchgehen.' },
      overview: { title: 'Planetenübersicht', content: 'Hier siehst du deine Planeteninfos, Ressourcenproduktion und Bauwarteschlange.' },
      buildSolar: { title: 'Solarkraftwerk bauen', content: 'Das Solarkraftwerk ist deine Energiegrundlage. Baue es zuerst, um andere Einrichtungen zu versorgen.' },
      buildMetal: { title: 'Metallmine bauen', content: 'Metall ist die grundlegendste Ressource, die für die meisten Gebäude und Schiffe verwendet wird.' },
      buildCrystal: { title: 'Kristallmine bauen', content: 'Kristall wird für Forschung und den Bau fortschrittlicher Schiffe benötigt.' },
      researchLab: { title: 'Forschungslabor bauen', content: 'Du brauchst ein Forschungslabor, um Technologieerforschung freizuschalten.' },
      researchTech: { title: 'Forschung', content: 'Erforsche hier Technologien, um deine Flotte und Produktionseffizienz zu verbessern.' },
      shipyard: { title: 'Raumschiffwerft', content: 'Baue hier Schiffe und Verteidigungsanlagen.' },
      galaxy: { title: 'Galaxieansicht', content: 'Erkunde das Universum und entdecke andere Spieler und Ressourcen.' },
      checkin: { title: 'Tägliches Einchecken', content: 'Checke täglich ein für Belohnungen. Aufeinanderfolgende Check-ins geben bessere Belohnungen!' },
      complete: { title: 'Tutorial abgeschlossen', content: 'Du kennst jetzt die Grundlagen. Baue dein kosmisches Imperium!' }
    }
  },
  sound: {
    title: 'Soundeinstellungen',
    soundEnabled: 'Soundeffekte aktivieren',
    musicEnabled: 'Hintergrundmusik aktivieren',
    soundVolume: 'SFX-Lautstärke',
  ...
  statistics: {
    ...
    buildings: 'Gebäude',
    research: 'Forschung',
    fleetAndCombat: 'Flotte & Kampf',
    trade: 'Handel',
    checkIn: 'Einchecken',
    empire: 'Imperiumübersicht',
    totalBuildings: 'Gebäude insgesamt',
    totalBuildingLevels: 'Gebäudestufen insgesamt',
    buildingScore: 'Gebäudepunkte',
    totalResearch: 'Forschungen insgesamt',
    totalResearchLevels: 'Forschungsstufen insgesamt',
    researchScore: 'Forschungspunkte',
    totalShips: 'Schiffe insgesamt',
    fleetDispatches: 'Flottenentsendungen',
    battlesWon: 'Gewonnene Kämpfe',
    battlesLost: 'Verlorene Kämpfe',
    winRate: 'Siegrate',
    totalTrades: 'Handel insgesamt',
    darkMatterSpent: 'Dunkle Materie ausgegeben',
    totalCheckInDays: 'Einchecktage insgesamt',
    currentStreak: 'Aktuelle Serie',
    planets: 'Planeten',
    moons: 'Monde',
    accountAge: 'Kontoalter (Tage)',
    bookmarks: 'Lesezeichen'
  },
  battleReports: {
    title: 'Kampfberichte',
    totalBattles: 'Gesamtkämpfe',
    winRate: 'Siegrate',
    totalPlunder: 'Gesamtplünderung',
    ...
    noReports: 'Keine Kampfberichte',
    lossShort2: 'Verluste',
    rounds: 'Runden',
    prevPage: 'Zurück',
    nextPage: 'Weiter',
    unknownOpponent: 'Unbekannter Gegner',
    attackerTechs: 'Angreifer-Tech',
    defenderTechs: 'Verteidiger-Tech',
    weaponTech: 'Waffen',
    shieldTech: 'Schild',
    armorTech: 'Panzerung',
  ...
  queueManagement: {
    ...
    waitingQueue: 'Wartende Warteschlange',
    emptyActive: 'Keine aktiven Bauaufgaben',
    emptyWaiting: 'Warteschlange ist leer',
    cancel: 'Abbrechen',
    building: 'Gebäude',
    ship: 'Schiff',
    defense: 'Verteidigung',
    demolish: 'Abreißen',
    scrapShip: 'Verschrotten',
    planet: 'Planet',
    status: 'Status',
    estimatedTime: 'Geschätzte Fertigstellung',
