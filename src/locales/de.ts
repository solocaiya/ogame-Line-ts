export default {
  ...
  settings: {
    ...
    reset: 'Zurücksetzen',
    profile: 'Profil',
    profileDesc: 'Ändere deinen im Spiel angezeigten Namen',
    currentName: 'Aktueller Name',
    displayName: 'Anzeigename',
    displayNamePlaceholder: 'Neuen Namen eingeben (3-20 Zeichen)',
    firstRenameFree: 'Erste Umbenennung kostenlos',
    renameCost: 'Umbenennungsgebühr',
    renameCount: '{count}x umbenannt',
    saveName: 'Name speichern',
    nameLengthError: 'Name muss 3-20 Zeichen lang sein',
    nameSameError: 'Neuer Name ist identisch mit dem aktuellen',
    profileSaved: 'Name erfolgreich geändert',
    profileSaveFailed: 'Name konnte nicht geändert werden',
    nameChangedNotice: 'Spieler {oldName} heißt jetzt {newName}',
    about: 'Über',
    version: 'Version',
  ...
  alliance: {
    ...
    requests: 'Anfragen',
    settings: 'Einstellungen',
    search: 'Allianzen suchen',
    searchPlaceholder: 'Nach Name oder Tag suchen...',
    noAlliance: 'Du bist in keiner Allianz',
    joinAlliance: 'Allianz beitreten',
    requestToJoin: 'Beitritt anfragen',
    invitePlayer: 'Spieler einladen',
    leave: 'Allianz verlassen',
    leaveConfirm: 'Bist du sicher, dass du die Allianz verlassen möchtest?',
    disband: 'Allianz auflösen',
    disbandConfirm: 'Bist du sicher? Alle Mitglieder werden entfernt.',
    promote: 'Befördern',
    demote: 'Degradieren',
    kick: 'Entfernen',
    kickConfirm: 'Bist du sicher, dass du {name} entfernen möchtest?',
    role: {
      leader: 'Anführer',
      officer: 'Offizier',
      member: 'Mitglied'
    ...
    requestMessage: 'Nachricht (optional)',
    accept: 'Annehmen',
    reject: 'Ablehnen',
    ...
    namePlaceholder: 'Allianzname eingeben',
    tagPlaceholder: 'z.B. ABC',
    tagHint: '3-8 Buchstaben oder Zahlen',
    noResults: 'Keine Allianzen gefunden',
  ...
  chat: {
    ...
    dnd: {
      title: 'Nicht stören',
      none: 'Aus',
      mute_world: 'Weltkanal stumm',
      mute_alliance: 'Allianzkanal stumm',
      mute_all: 'Alles stumm'
    },
    newMessage: 'hat eine neue Nachricht gesendet',
    noMessages: 'Noch keine Nachrichten'
  },

  recharge: {
    title: 'Dunkle Materie Aufladen',
    mockNotice: 'Testmodus — Klick auf Kaufen simuliert die Zahlung',
    tabRecharge: 'Aufladen',
    tabMonthly: 'Monatskarte',
    tabGifts: 'Geschenkpakete',
    buy: 'Kaufen',
    firstBonus: 'Erster Bonus',
    bonus: 'Bonus',
    purchaseSuccess: 'Aufladung erfolgreich! {amount} Dunkle Materie erhalten',
    dailyClaimTitle: 'Tägliche Dunkle Materie',
    dailyClaimDesc: 'Sie haben eine aktive Monatskarte — heute kostenlos abholen',
    claim: 'Abholen',
    claimed: 'Abgeholt',
    dailyClaimSuccess: 'Erfolgreich abgeholt! {amount} Dunkle Materie erhalten',
    buyCard: 'Karte kaufen',
    active: 'Aktiv',
    expiresIn: '{days} Tage verbleibend',
    day: 'Tag',
    cardPurchaseSuccess: 'Monatskarte gekauft!',
    perks: {
    ...
    buyGift: 'Paket kaufen',
    noGifts: 'Keine Geschenkpakete verfügbar',
    giftPurchaseSuccess: 'Geschenkpaket gekauft!'
  },

  accelerate: {
    title: 'Beschleunigen',
    cost: 'Kosten: {amount} Dunkle Materie',
    confirm: 'Bestätigen',
    remaining: 'Verbleibend',
    ...
    research: 'Forschung beschleunigen',
    shipBuild: 'Schiffsbau beschleunigen',
    fleetTravel: 'Flotte beschleunigen',
  ...
  growthFund: {
    title: 'Wachstumsfonds',
    heroTitle: 'Wachstumsfonds — Langzeitinvestition',
    heroDesc: 'Einmalig kaufen und schrittweise bis zu 22.000 Dunkle Materie als Belohnung erhalten!',
    totalReturn: 'Gesamtrendite',
    cost: 'Preis',
    howItWorks: 'Nach dem Kauf sammelst du Punkte durch das Ausgeben von Dunkler Materie. Erreiche Punkte-Meilensteine, um DM-Belohnungen freizuschalten.',
    buyButton: 'Wachstumsfonds kaufen',
    buySuccess: 'Wachstumsfonds gekauft!',
    buyFailed: 'Kauf fehlgeschlagen',
    claimed: 'Erhalten',
    remaining: 'Verbleibend',
    myPoints: 'Meine Punkte',
    nextStage: 'Fortschritt zur nächsten Stufe',
    nextStageReward: '{amount} Dunkle Materie bei Abschluss',
    allClaimed: 'Alle Belohnungen erhalten!',
    totalClaimedAmount: 'Insgesamt {amount} DM erhalten',
    stages: 'Belohnungsstufen',
    claim: 'Einlösen',
    loadFailed: 'Wachstumsfonds konnte nicht geladen werden',
    claimSuccess: 'Eingelöst! {amount} Dunkle Materie erhalten',
    claimFailed: 'Einlösung fehlgeschlagen',
    pointsReq: 'Benötigt {points} Punkte',
