export default {
  ...
  recharge: {
    title: '暗物质充值',
    mockNotice: '当前为测试模式，点击购买即模拟完成支付',
    tabRecharge: '充值',
    tabMonthly: '月卡',
    tabGifts: '礼包',
    buy: '购买',
    firstBonus: '首充奖励',
    bonus: '赠送',
    purchaseSuccess: '充值成功！获得 {amount} 暗物质',
    dailyClaimTitle: '每日暗物质领取',
    dailyClaimDesc: '您已激活月卡，今日可领取免费暗物质',
    claim: '领取',
    claimed: '已领取',
    dailyClaimSuccess: '领取成功！获得 {amount} 暗物质',
    buyCard: '购买月卡',
    active: '已激活',
    expiresIn: '剩余 {days} 天',
    day: '天',
    cardPurchaseSuccess: '月卡购买成功！',
    perks: {
  ...
  accelerate: {
    ...
    remaining: '剩余时间',
    skipTime: '跳过时间',
    costPerHour: '加速费用按类型区分：建筑200/研究250/造船300 DM/时，舰队旅行500 DM/次(固定)',
  ...
  growthFund: {
    title: '成长基金',
    heroTitle: '成长基金 — 长期投资计划',
    heroDesc: '一次性购买成长基金，随着你的游戏进度逐步领取总计 22,000 暗物质奖励！',
    totalReturn: '总返还',
    cost: '价格',
    howItWorks: '购买后，通过消费暗物质积累积分。积分达到各阶段要求时，即可领取对应暗物质奖励。',
    buyButton: '购买成长基金',
    buySuccess: '成长基金购买成功！',
    buyFailed: '购买失败',
    claimed: '已领取',
    ...
    myPoints: '我的积分',
    nextStage: '下一阶段进度',
    nextStageReward: '达成后可领取 {amount} 暗物质',
    allClaimed: '所有奖励已领取！',
    totalClaimedAmount: '累计领取 {amount} 暗物质',
    stages: '奖励阶段',
    claim: '领取',
    loadFailed: '加载成长基金失败',
    claimSuccess: '领取成功！获得 {amount} 暗物质',
    claimFailed: '领取失败',
    pointsReq: '需要 {points} 积分',
    reward: '奖励 {amount} DM',
    statusClaimed: '已领取',
    statusClaimable: '可领取',
    statusLocked: '未达成',
