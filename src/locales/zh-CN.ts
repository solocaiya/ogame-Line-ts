export default {
  ...
  settings: {
    ...
    battleModeEnabled: '战斗到底模式已启用',
    battleModeDisabled: '战斗到底模式已关闭',
    pause: '暂停',
    resume: '恢复',
    gamePaused: '游戏已暂停',
    gameResumed: '游戏已恢复',
    ...
    reset: '重置',
    profile: '个人资料',
    profileDesc: '修改游戏中显示的名称（昵称）',
    currentName: '当前名称',
    displayName: '昵称',
    displayNamePlaceholder: '请输入新昵称（3-20个字符）',
    firstRenameFree: '首次改名免费',
    renameCost: '改名费用',
    renameCount: '已改名 {count} 次',
    saveName: '保存昵称',
    nameLengthError: '昵称长度需在3-20个字符之间',
    nameSameError: '新昵称与当前昵称相同',
    profileSaved: '昵称修改成功',
    profileSaveFailed: '昵称修改失败',
    nameChangedNotice: '玩家 {oldName} 已改名为 {newName}',
    about: '关于',
    version: '版本',
    checkUpdate: '检查更新',
    checking: '检查中...',
  ...
  trader: {
    title: '资源交易所',
    exchangeRates: '汇率说明',
    exchangeRatesDesc: '使用暗物质兑换基础资源',
    feeNotice: '每笔交易收取 {fee}% 手续费',
    tradePanel: '交易面板',
    currentDarkMatter: '当前暗物质',
    darkMatterAmount: '暗物质数量',
    enterAmount: '输入数量',
    maxTrade: '单笔上限',
    preview: '交易预览（扣除手续费后）',
    fee: '手续费',
  ...
  tutorial: {
    ...
    finish: '完成引导',
    steps: {
      welcome: { title: '欢迎来到无限星辰', content: '这是一个宇宙策略游戏，你将建立帝国、发展科技、组建舰队。让我们快速了解一下基本玩法。' },
      overview: { title: '星球总览', content: '这里显示你的星球基本信息、资源产量和建筑队列。' },
      buildSolar: { title: '建造太阳能电站', content: '太阳能电站是能源的基础，先建造它来为其他设施供电。' },
      buildMetal: { title: '建造金属矿', content: '金属是最基础的资源，用于建造大部分建筑和舰船。' },
      buildCrystal: { title: '建造水晶矿', content: '水晶用于研究科技和建造高级舰船。' },
      researchLab: { title: '建造研究实验室', content: '有了研究实验室才能解锁科技研究。' },
      researchTech: { title: '科技研究', content: '在这里研究各种科技，提升舰队战斗力和生产效率。' },
      shipyard: { title: '船坞', content: '建造舰船和防御设施的地方。' },
      galaxy: { title: '星系视图', content: '探索宇宙，发现其他玩家和可用资源。' },
      checkin: { title: '每日签到', content: '每天签到领取奖励，连续签到奖励更丰厚！' },
      complete: { title: '引导完成', content: '你已经了解了基本玩法，现在去建立你的宇宙帝国吧！' }
    }
  },
  sound: {
    title: '音效设置',
  ...
  statistics: {
    ...
    buildings: '建筑统计',
    research: '科技统计',
    fleetAndCombat: '舰队与战斗',
    trade: '交易统计',
    checkIn: '签到统计',
    empire: '帝国概况',
    totalBuildings: '建筑总数',
    totalBuildingLevels: '建筑总等级',
    buildingScore: '建筑得分',
    totalResearch: '科技总数',
    totalResearchLevels: '科技总等级',
    researchScore: '科技得分',
    totalShips: '舰船总数',
    fleetDispatches: '舰队派遣次数',
    battlesWon: '战斗胜利',
    battlesLost: '战斗失败',
    winRate: '胜率',
    totalTrades: '交易总次数',
    darkMatterSpent: '暗物质消费',
