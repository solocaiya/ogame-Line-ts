export default {
  ...
  nav: {
    ...
    trader: 'Обмен',
    recharge: 'Пополнение',
    growthFund: 'Фонд роста',
    bookmarks: 'Закладки',
    statistics: 'Статистика',
    battleReports: 'Отчёты',
    queueManagement: 'Очередь',
    gm: 'GM',
    alliance: 'Альянс'
  },
  sidebar: {
  ...
  settings: {
    ...
    battleModeEnabled: 'Режим боя до конца включён',
    battleModeDisabled: 'Режим боя до конца выключен',
    pause: 'Пауза',
    resume: 'Возобновить',
    ...
    reset: 'Сбросить',
    profile: 'Профиль',
    profileDesc: 'Изменить отображаемое имя в игре',
    currentName: 'Текущее имя',
    displayName: 'Отображаемое имя',
    displayNamePlaceholder: 'Введите новое имя (3-20 символов)',
    firstRenameFree: 'Первое переименование бесплатно',
    renameCost: 'Стоимость переименования',
    renameCount: 'Переименовано {count} раз',
    saveName: 'Сохранить имя',
    nameLengthError: 'Имя должно содержать 3-20 символов',
    nameSameError: 'Новое имя совпадает с текущим',
    profileSaved: 'Имя успешно изменено',
    profileSaveFailed: 'Не удалось изменить имя',
    nameChangedNotice: 'Игрок {oldName} теперь известен как {newName}',
    about: 'О программе',
    version: 'Версия',
  ...
  privacy: {
    ...
    sections: {
      introduction: {
        title: 'Введение',
        content:
          'Эта политика конфиденциальности объясняет, как Infinite Stars обрабатывает ваши данные. Мы стремимся защищать вашу конфиденциальность, и эта игра разработана с полным уважением к приватности пользователей.'
      },
      dataCollection: {
        title: 'Сбор данных',
  ...
  tutorial: {
    ...
    welcome: {
      title: 'Добро пожаловать в Infinite Stars',
      content:
    ...
    mobile: {
      welcome: {
        title: 'Добро пожаловать в Infinite Stars (Мобильная версия)',
        content:
  ...
  trader: {
    ...
    exchangeRatesDesc: 'Обменяйте тёмную материю на базовые ресурсы',
    feeNotice: 'Комиссия {fee}% за транзакцию',
    tradePanel: 'Панель торговли',
    currentDarkMatter: 'Текущая тёмная материя',
    darkMatterAmount: 'Количество тёмной материи',
    enterAmount: 'Введите количество',
    maxTrade: 'Максимум за сделку',
    preview: 'Предпросмотр сделки (после комиссии)',
    fee: 'Комиссия',
    noPlanet: 'Сначала выберите планету',
    history: 'История сделок',
    noHistory: 'Нет истории сделок'
  },
  bookmark: {
    title: 'Закладки',
    ...
    all: 'Все',
    starred: 'Избранное',
    empty: 'Нет закладок. Нажмите вверху справа, чтобы добавить.',
    name: 'Название',
    namePlaceholder: 'Введите название закладки',
    galaxy: 'Галактика',
    system: 'Система',
    position: 'Позиция',
    category: 'Категория',
  ...
  tutorial: {
    ...
    finish: 'Завершить',
    steps: {
      welcome: { title: 'Добро пожаловать в Infinite Stars', content: 'Это космическая стратегия, где вы строите империю, исследуете технологии и командуете флотом. Давайте быстро ознакомимся с основами.' },
      overview: { title: 'Обзор планеты', content: 'Здесь отображается информация о планете, производство ресурсов и очередь строительства.' },
      buildSolar: { title: 'Постройте солнечную электростанцию', content: 'Солнечная электростанция — основа энергетики. Постройте её первой для питания других объектов.' },
      buildMetal: { title: 'Постройте шахту металла', content: 'Металл — базовый ресурс, используемый для большинства зданий и кораблей.' },
      buildCrystal: { title: 'Постройте шахту кристаллов', content: 'Кристаллы нужны для исследований и строительства продвинутых кораблей.' },
      researchLab: { title: 'Постройте исследовательскую лабораторию', content: 'Лаборатория необходима для разблокировки исследований.' },
      researchTech: { title: 'Исследования', content: 'Изучайте технологии для улучшения флота и эффективности производства.' },
      shipyard: { title: 'Верфь', content: 'Стройте корабли и средства обороны.' },
      galaxy: { title: 'Обзор галактики', content: 'Исследуйте вселенную и открывайте других игроков и ресурсы.' },
      checkin: { title: 'Ежедневная отметка', content: 'Отмечайтесь ежедневно для получения наград. Серия отметок даёт лучшие награды!' },
      complete: { title: 'Обучение завершено', content: 'Вы знаете основы. Пора строить свою космическую империю!' }
    }
  },
  sound: {
    title: 'Настройки звука',
    soundEnabled: 'Включить звуковые эффекты',
    musicEnabled: 'Включить фоновую музыку',
  ...
  statistics: {
    ...
    buildings: 'Здания',
    research: 'Исследования',
    fleetAndCombat: 'Флот и бой',
    trade: 'Торговля',
    checkIn: 'Отметки',
    empire: 'Обзор империи',
    totalBuildings: 'Всего зданий',
    totalBuildingLevels: 'Общий уровень зданий',
    buildingScore: 'Очки зданий',
    totalResearch: 'Всего исследований',
    totalResearchLevels: 'Общий уровень исследований',
    researchScore: 'Очки исследований',
    totalShips: 'Всего кораблей',
    fleetDispatches: 'Отправки флота',
    battlesWon: 'Победы',
    battlesLost: 'Поражения',
    winRate: 'Процент побед',
    totalTrades: 'Всего сделок',
    darkMatterSpent: 'Потрачено тёмной материи',
    totalCheckInDays: 'Всего дней отметок',
    currentStreak: 'Текущая серия',
    planets: 'Планеты',
    moons: 'Луны',
    accountAge: 'Возраст аккаунта (дни)',
    bookmarks: 'Закладки'
  },
  battleReports: {
    title: 'Боевые отчёты',
    ...
    noReports: 'Нет боевых отчётов',
    lossShort2: 'Потери',
    rounds: 'раундов',
    prevPage: 'Назад',
    nextPage: 'Далее',
    unknownOpponent: 'Неизвестный противник',
    attackerTechs: 'Технологии атакующего',
    defenderTechs: 'Технологии защитника',
    weaponTech: 'Оружие',
    shieldTech: 'Щит',
    armorTech: 'Броня',
  ...
  queueManagement: {
    ...
    waitingQueue: 'Ожидающая очередь',
    emptyActive: 'Нет активных задач строительства',
    emptyWaiting: 'Ожидающая очередь пуста',
    cancel: 'Отмена',
    building: 'Здание',
    ship: 'Корабль',
    defense: 'Оборона',
    demolish: 'Снос',
    scrapShip: 'Утилизация',
    planet: 'Планета',
    status: 'Статус',
    estimatedTime: 'Расч. завершение',
  ...
  alliance: {
    ...
    requests: 'Заявки',
    settings: 'Настройки',
    search: 'Поиск альянсов',
    searchPlaceholder: 'Поиск по названию или тегу...',
    noAlliance: 'Вы не состоите в альянсе',
    joinAlliance: 'Вступить в альянс',
    requestToJoin: 'Подать заявку',
    invitePlayer: 'Пригласить игрока',
    leave: 'Покинуть альянс',
    leaveConfirm: 'Вы уверены, что хотите покинуть альянс?',
    disband: 'Распустить альянс',
    disbandConfirm: 'Вы уверены, что хотите распустить альянс? Все участники будут удалены.',
    promote: 'Повысить',
    demote: 'Понизить',
    kick: 'Исключить',
    kickConfirm: 'Вы уверены, что хотите исключить {name}?',
    role: {
      leader: 'Лидер',
      officer: 'Офицер',
      member: 'Участник'
    ...
    requestMessage: 'Сообщение к заявке (необязательно)',
    accept: 'Принять',
    reject: 'Отклонить',
    ...
    namePlaceholder: 'Введите название альянса',
    tagPlaceholder: 'Например: ABC',
    tagHint: '3-8 букв или цифр',
    noResults: 'Альянсы не найдены',
  ...
  chat: {
    ...
    dnd: {
      title: 'Не беспокоить',
      none: 'Выкл',
      mute_world: 'Отключить мировой канал',
      mute_alliance: 'Отключить канал альянса',
      mute_all: 'Отключить все'
    },
    newMessage: 'отправил новое сообщение',
    noMessages: 'Пока нет сообщений'
  },

  recharge: {
    title: 'Пополнение Тёмной Материи',
    mockNotice: 'Тестовый режим — нажатие «Купить» имитирует оплату',
    tabRecharge: 'Пополнение',
    tabMonthly: 'Месячная карта',
    tabGifts: 'Подарочные наборы',
    buy: 'Купить',
    firstBonus: 'Первый бонус',
    bonus: 'Бонус',
    purchaseSuccess: 'Пополнение успешно! Получено {amount} Тёмной Материи',
    dailyClaimTitle: 'Ежедневная Тёмная Материя',
    dailyClaimDesc: 'У вас активна месячная карта — заберите бесплатную тёмную материю сегодня',
    claim: 'Забрать',
    claimed: 'Получено',
    dailyClaimSuccess: 'Успешно получено! {amount} Тёмной Материи',
    buyCard: 'Купить карту',
    active: 'Активна',
    expiresIn: 'Осталось {days} дн.',
    day: 'день',
    cardPurchaseSuccess: 'Месячная карта куплена!',
    perks: {
    ...
    buyGift: 'Купить набор',
    noGifts: 'Нет доступных подарочных наборов',
    giftPurchaseSuccess: 'Подарочный набор куплен!'
  },

  accelerate: {
    title: 'Ускорить',
    cost: 'Стоимость: {amount} Тёмная материя',
    confirm: 'Подтвердить',
    remaining: 'Осталось',
    skipTime: 'Пропустить',
    costPerHour: 'Зависит от типа: здание 200 / исследование 250 / постройка 300 DM/ч, полёт флота 500 DM/полёт (фикс.)',
    insufficientDM: 'Недостаточно Тёмной материи',
    success: 'Ускорено! Пропущено {time}',
    building: 'Ускорить строительство',
    research: 'Ускорить исследование',
    shipBuild: 'Ускорить постройку',
    fleetTravel: 'Ускорить флот',
  ...
  growthFund: {
    title: 'Фонд роста',
    heroTitle: 'Фонд роста — Долгосрочные инвестиции',
    heroDesc: 'Купите один раз и получайте до 22 000 тёмной материи поэтапно по мере игры!',
    totalReturn: 'Общая доходность',
    cost: 'Цена',
    howItWorks: 'После покупки вы набираете очки, тратя тёмную материю. Достигайте порогов очков для получения наград DM на каждом этапе.',
    buyButton: 'Купить фонд роста',
    buySuccess: 'Фонд роста куплен!',
    buyFailed: 'Ошибка покупки',
    claimed: 'Получено',
    remaining: 'Осталось',
    myPoints: 'Мои очки',
    nextStage: 'Прогресс до следующего этапа',
    nextStageReward: 'После завершения — {amount} тёмной материи',
    allClaimed: 'Все награды получены!',
    totalClaimedAmount: 'Всего получено: {amount} DM',
    stages: 'Этапы наград',
    claim: 'Получить',
    loadFailed: 'Не удалось загрузить фонд роста',
    claimSuccess: 'Получено! {amount} тёмной материи',
    claimFailed: 'Ошибка получения',
    pointsReq: 'Требуется {points} очков',
