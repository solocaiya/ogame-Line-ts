export default {
  ...
  moon: {
    giftMoon: 'Подарочная луна',
    firstLoginTitle: 'Добро пожаловать, командир!',
    firstLoginDesc: 'Как новый командир, вы получили бесплатную луну в подарок!',
    firstLoginHint: 'На луне можно строить специальные здания: лунная база, сенсорный фаланг и прыжковые ворота.',
    claimGift: 'Получить подарок'
  },
  checkIn: {
    title: 'Ежедневная отметка',
    progress: 'Прогресс отметок',
    progressDesc: 'Текущий цикл: {current}/{total} дней',
    day: 'День {day}',
    claim: 'Получить',
    claimed: 'Получено',
    locked: 'Заблокировано',
    ...
    available: 'Доступно',
    rules: 'Правила',
    rule1: 'Отмечайтесь ежедневно для получения наград. Последовательные отметки увеличивают награды.',
    rule2: 'Цикл отметок сбрасывается каждые 7 дней.',
    rule3: 'Пропуск дня сбрасывает прогресс цикла.',
    noPlanet: 'Планета не выбрана',
    success: 'Отметка успешна! Получена награда за день {day}',
    alreadyClaimed: 'Сегодня уже отмечено'
  }
}
